...
async function renderLectureCounts() {
    ...
    try {
        ...
        document.getElementById('total-lectures').textContent = counts.total;
        document.getElementById('lectures-completed').textContent = counts.completed;
        document.getElementById('lectures-left').textContent = counts.left;
    } catch (err) {
        document.getElementById('total-lectures').textContent = '-';
        document.getElementById('lectures-completed').textContent = '-';
        document.getElementById('lectures-left').textContent = '-';
    }
}
